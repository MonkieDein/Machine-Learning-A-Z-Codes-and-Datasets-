# Random Forest 
#
# A ensemble learning method that select K data from sampling N times
# then it takes the average prediction.
#
...
classifier = randomForest(y=train_df[[y]],x = train_df[IV],ntree=20)
