# SVM Classifier
# SVM classifier is a linear classifer that 
# maximize margin of the support vectors.
#
# Unlike standard algorithms focus on standard representation.
# SVM assign decision based on the boundary representation.
#
...
y_pred = predict(classifier,type='response',newdata = test_df[IV]) 
